								...
								<tr>
									<td> 
										<div style="display: block; padding-top: 5px;text-align: left; padding-bottom: 5px; font-weight: bold;">
											<a href="<?php echo $new['New']['address']; ?>" onclick="window.open('<?php echo $new['New']['address']; ?>')"><?php echo $new['New']['title']; ?></a>
										</div>
										
										<a style="margin-right: 20px" href="<?php echo $new['New']['address']; ?>" onclick="window.open('<?php echo $new['New']['address']; ?>')" class="media-new">
