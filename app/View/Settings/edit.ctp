					...
					<div class="col-xs-10 col-center">
						<?php echo $this->Form->create('Setting', array('id' => 'Setting','role' => 'form')); ?>
							<div class="col-xs-12 form-group text-right" style="padding-right:30px">
								...
								<?php echo $this->Form->input('id',array('type' => 'hidden', 'value'=> $this->request->data['Setting']['id'])) ?>
							</div>
							...
							<div class="col-xs-12 form-group">
								<div class="col-xs-3 text-light-blue text-bold text-right"><label>Active<i class="fa fa-asterisk fa-lg"></i></label></div>
								<div class="col-xs-9 text-left"><?php echo $this->Form->input('active', array('type' => 'checkbox','class' => 'form-control', 'placeholder' => 'Category Id','label' => false));?></div>
							</div>
							<div class="col-xs-12 form-group text-right">
								<?php echo $this->Form->button('<span class="fa fa-check"></span> Submit', array('onclick' => 'checkValidSetting()','class' => 'btn btn-flat btn-success','type'=>'button')); ?>
								<?php echo $this->Html->link('<span class="fa fa-times"></span> Cancel','/Settings/',array('class' => 'btn btn-flat btn-danger','style' => 'margin-left:5px', 'escape'=>false)); ?>
							</div>
